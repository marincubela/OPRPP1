...
/**
 * Sučelje koje predstavlja neku skupinu (kolekciju) objekata parametriziranih po tipu T.
 * 
 * @author Cubi
 *
 * @param <T> tip objekata koji se spremaju u kolekciju.
 */
